...
function wh=bendingRods5wPlot(x, wh)
%
% INPUTS: 
...
% external force
s_pole=x(1); % contour location where force f_pole is applied
f_pole=x(2); % force that is applied at s_pole
...
% Experimentally defined for C2 of JF25395 & JF25403
