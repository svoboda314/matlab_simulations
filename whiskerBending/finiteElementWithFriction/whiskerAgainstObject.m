...
%
% Rigid object is on the y-axis; together with follicle. Whisker protracts
% against the object.
% Calculates the contour of the whisker and the forces acting on it. This is
% done using the function whiskerBentByForce, which calculates the shape of a 
% whisker with an applie force. The Matlab function fminsearch is used to
% find the combination of forces and force position that produces a contour
% consistent with the object location.
% See also Solomon and Hartmann, Nature, 2006; Supplemental Materials
%
%INPUT
...
r1=rotTheta0*r0;
rotTheta0=[cos(-theta0) -sin(-theta0); sin(-theta0) cos(-theta0)];
a=r1'; % rotate so that theta at base is 0 (i.e. whisker base is along y axis)
