...
%% Compute whisker deflections for a few angles (first contact at theta=0)
%
...
r0=[ 0 pole_pos_in_mm/1000]'; % pole pos in meters (x, y) 
...
% kTheta = 5e-6; % in rad/(Nm); larger means stiffer 
...
line(intendedAnglesAtBases, f_tot)
