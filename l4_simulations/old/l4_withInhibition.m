...
net.l4_fs.cp=0.5;
net.l4_fs.psp=2; % in mv; psps per ap
...
net.fs_l4.cp=0.5;
net.fs_l4.s=0.1; % in nS; conductance per ap CHECK OUT
...
for i=2:tsteps
    ...
    % update l4 voltage
    net.l4.vm(:, i)=net.l4.vm(:, i-1)*exp(-tstep/net.l4.tau)+net.vpm_l4.psp*net.vpm_l4.cm*vpm_spikes'+ ...
        net.l4_l4.psp*net.l4_l4.cm*net.l4.spikes(:, i-1)-...
        net.fs_l4.s*net.l4.vm(:, i-1).*(net.fs_l4.cm*net.fs.spikes(:, i-1));
    net.l4.vm(temp_l4, i)=0;       % reset to 0   
    %update fs voltage
    net.fs.vm(:, i)=net.fs.vm(:, i-1)*exp(-tstep/net.fs.tau)+net.vpm_fs.psp*net.vpm_fs.cm*vpm_spikes'+ ...
